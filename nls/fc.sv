...
1.13: /LBn  Sätter maximalt antal konsekutiva olika ASCII-rader till n
1.14: /nnn  Sätt minsta antal konsekutiva matchande rader till nnn
1.15:       för omsynkronisering vid jämförelse
1.16: /R    Visa en kort slutrapport (alltid aktiv när /S används)
1.17: /Q    Visa inte listan över skillnader
1.18: /U    Visa filnamnen för filer som inte har någon motsvarighet
#### Messages    ####
...
2.12:Omsynkronisering misslyckades: filerna är allt för olika
2.13:Filerna är olika stora
2.14:Filerna är olika
2.15:Fil %s har ingen motsvarighet(%s)
#### Report text ####
3.0:Jämförde %d filer
3.1: i %d kataloger
